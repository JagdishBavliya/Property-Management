...
export default function AdminDetailPage() {
  ...
  return (
    <>
      <Head>
        <title>{admin ? admin.name : 'Admin Details'} | PMS</title>
      </Head>
          ...
          <div className="flex items-center gap-4 py-6">
            <Breadcrumb
              items={[
                ...
                { label: admin?.name || 'Admin', icon: UserIcon }
              ]}
              backButtonText="Admins"
              backButtonHref="/admins"
            />
          </div>
        </div>
          ...
          <div className="xl:col-span-4 mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card variant="elevated" className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-lg font-bold text-gray-900">System Management</div>
                  <div className="text-sm text-gray-500">Coming soon: Admin&apos;s system management stats and activity</div>
                </div>
              </Card>
              <Card variant="elevated" className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Coming soon: Admin&apos;s notes, logs, and more</div>
                </div>
              </Card>
            </div>
          </div>
